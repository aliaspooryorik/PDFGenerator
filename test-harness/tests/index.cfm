...
<head>
	...
	<title>PDFGenerator TestBox Browser</title>
	<cfoutput>
	...
	<div class="row">
		<div class="col-md-12">
			<form name="runnerForm" id="runnerForm">
				...
				<h2>PDFGenerator TestBox Test Browser: </h2>
				<p>
				...
				<fieldset>
					...
					<cfif url.path neq "/">
						<a class="btn btn-secondary btn-sm my-1" href="index.cfm?path=#URLEncodedFormat( backPath )#">⬅ Back</a><br/>
					</cfif>

					<cfloop query="qResults">
						<cfif qResults.type eq "dir">
							<a class="btn btn-light btn-sm my-1" href="index.cfm?path=#URLEncodedFormat( url.path & qResults.name )#">📁 #qResults.name#</a><br/>
