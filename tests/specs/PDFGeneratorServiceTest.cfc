        ...
        describe('PDFGeneratorService', function() {
            ...
            describe('HTML to PDF Binary Conversion', function() {
                it('should convert simple HTML to PDF binary', function() {
                    ...
                    var result = variables.pdfGenerator.htmlToPDFResult(html);

                    expect(result).toBeComponent();
                    expect(result.isSuccess()).toBeTrue();
                    expect(len(result.getBase64String())).toBeGT(0);
            ...
            describe('PDF Options Configuration', function() {
                it('should respect orientation settings', function() {
                    ...
                    var portraitOptions = new pdfgenerator.models.PDFOptions()
                        ...
                        .setPageSize('A4');
                    var portraitResult = variables.pdfGenerator.htmlToPDFResult(html, portraitOptions);

                    // Test landscape
                    var landscapeOptions = new pdfgenerator.models.PDFOptions()
                        .setOrientation('landscape')
                        .setPageSize('A4');
                    var landscapeResult = variables.pdfGenerator.htmlToPDFResult(html, landscapeOptions);
                ...
                it('should respect page size settings', function() {
                    ...
                    var a4Result = variables.pdfGenerator.htmlToPDFResult(html, a4Options);

                    // Test A3
                    var a3Options = new pdfgenerator.models.PDFOptions().setPageSize('A3');
                    var a3Result = variables.pdfGenerator.htmlToPDFResult(html, a3Options);
                ...
                it('should respect margin settings', function() {
                    ...
                    // Test small margins
                    var smallMarginsOptions = new pdfgenerator.models.PDFOptions().setMargins(10, 10, 10, 10, 'mm');
                    var smallResult = variables.pdfGenerator.htmlToPDFResult(html, smallMarginsOptions);

                    // Test large margins
                    var largeMarginsOptions = new pdfgenerator.models.PDFOptions().setMargins(50, 50, 50, 50, 'mm');
                    var largeResult = variables.pdfGenerator.htmlToPDFResult(html, largeMarginsOptions);
            ...
            describe('Error Handling', function() {
                it('should handle invalid PDF options gracefully', function() {
                    ...
                    var invalidOptions = new pdfgenerator.models.PDFOptions().setOrientation('invalid');

                    var result = variables.pdfGenerator.htmlToPDFResult(html, invalidOptions);
                ...
                it('should handle null HTML input', function() {
                    expectToThrow(function() {
                        variables.pdfGenerator.htmlToPDFResult(javacast('null', ''));
                    });
                });

                it('should provide detailed error information', function() {
                    var invalidOptions = new pdfgenerator.models.PDFOptions().setPageSize('InvalidSize');
                    var result = variables.pdfGenerator.htmlToPDFResult('<html></html>', invalidOptions);
