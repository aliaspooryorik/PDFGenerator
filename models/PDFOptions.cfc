...
component {
    ...
    public boolean function isValid() {
        try {
            ...
            if (
                variables.marginTop < 0 || variables.marginBottom < 0 ||
    ...
    // Simple getters
    public string function getOrientation() {
        return variables.orientation;
    }
    public string function getPageSize() {
    ...
    public string function getMarginUnit() {
        return variables.marginUnit;
    }
    public numeric function getMarginTop() {
        return variables.marginTop;
    }
    public numeric function getMarginBottom() {
        return variables.marginBottom;
    }
    public numeric function getMarginLeft() {
        return variables.marginLeft;
    }
    public numeric function getMarginRight() {
        return variables.marginRight;
    }
    public boolean function getEmbedFonts() {
        return variables.embedFonts;
    }
    public string function getOutputPath() {
        return variables.outputPath;
    }
